...
document.annual_exams.startweek.options[<?php echo $oldday; ?>].selected = true;
document.annual_exams.endweek.options[<?php echo $oldday; ?>].selected = true;
document.annual_exams.startmonth.options[<?php echo $oldmonth-1; ?>].selected = true;
document.annual_exams.endmonth.options[<?php echo $oldmonth-1; ?>].selected = true;
}
...
<form action="SEARCH_CONFIRMATION.php" name="annual_exams" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      <tr>
        <td height="37" colspan="5" align="center" class="Verdana13B">DEFINE THE SEARCH PERIOD</td>
        </tr>
      <tr>
  ...
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      <tr>
        ...
        <td width="324" height="40" align="center" class="Verdana12"><label><input name="skipref" type="checkbox" id="skipref" value="1" /> 
