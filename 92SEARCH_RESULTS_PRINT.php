  ...
  <table width="854" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" frame="void" rules="cols">
    ...
    <tr class="Verdana11">
      <td height="20"><span style="background-color:#FFFF00" class="Verdana13B"><?php echo $row_RECALL['TITLE']." ".$row_RECALL['COMPANY'].", ".$row_RECALL['CONTACT']; ?></span>, <?php echo $row_RECALL['ADDRESS1'].", ".$row_RECALL['ADDRESS2'].", ".$row_RECALL['CITY'].", ".$row_RECALL['STATE'].", ".$row_RECALL['ZIP']; ?>&nbsp;&nbsp;<br />
        <?php echo "(".$row_RECALL['CAREA'].")".$row_RECALL['PHONE']." (".$row_RECALL['CAREA2'].")".$row_RECALL['PHONE2'].' ' . $row_RECALL['EMAIL']; ?></td>
      <td height="20">&nbsp;</td>
      <td height="20">&nbsp;</td>
      <td height="20">&nbsp;</td>
      <td height="20">&nbsp;</td>
...
$select_RECALL = "SELECT CUSTNO,COMPANY,CONTACT,TITLE,ADDRESS1,ADDRESS2,CITY,STATE,ZIP, CAREA,PHONE,PETNAME,PETTYPE,PSEX, 
...
do { ?>   
  ...
  <tr>
    <td width="614" height="360" align="left" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="45" colspan="3"></span><br /><span class="Verdana14B"><?php echo $row_CRITDATA['HOSPNAME']; ?></span><br />
<span class="Verdana11"><?php echo $row_CRITDATA['HSTREET']; ?>, <?php echo $row_CRITDATA['HCITY']; ?>, <?php echo $row_CRITDATA['HPROV']; ?> <?php echo $row_CRITDATA['HCODE']; ?></span></td>
      ...
      <tr>
        <td height="<?php if ($i == 3) {echo '20'; $i = 0;} else {echo "52";} ?>"></td>
        <td></td>
        <td></td>
      </tr>
    </table></td>
...
$totalRows_RECALL = mysqli_num_rows($RECALL);
 ...
 // $fp = fopen("$DOCUMENT_ROOT/Merges/ANNUAL.TXT", "w") ;
 
  if (file_exists("/Users/nvc/Desktop/ANNUAL.TXT")) {
   unlink('/Users/nvc/Desktop/ANNUAL.TXT') ;
  }

$fp = fopen("/Users/nvc/Desktop/ANNUAL.TXT", "x") ;
  if ($fp) {
  ...
  $line = array( $row_RECALL['CONTACT'], $row_RECALL['COMPANY'],'    ',  $row_RECALL['EMAIL'], $row_RECALL['TITLE'], $row_RECALL['PETNAME'], $isare, $heshe, $sex,  $isare ,
  $row_RECALL['ADDRESS1'], $row_RECALL['ADDRESS2'], $row_RECALL['CITY'], $row_RECALL['STATE'], $row_RECALL['ZIP'], $row_RECALL['EMAIL'], $row_RECALL['PHONE'], '  ', '  ', '  ', $row_RECALL['PETTYPE'],
  $row_RECALL['PSEX'], $row_RECALL['PDOB'],  $row_RECALL['PRABDAT'], $row_RECALL['POTHDAT'],  $row_RECALL['POTHFOR'], '  ', '  ',$neuter, date('F jS Y'), '  ', ' ',
  $row_RECALL['CYCLE'], ' ', $row_RECALL['POTH8']) ;
 
  fputcsv($fp, $line, $delimiter=chr(9)) ;
  
  echo "<span class='Verdana12'>".$row_RECALL['TITLE'].'", "'.$row_RECALL['CONTACT'].'", "'.$row_RECALL['COMPANY'].'", "'.$row_RECALL['ADDRESS1'].' '.$row_RECALL['ADDRESS2'].
  '",  "'.$row_RECALL['CITY'].'", "'.$row_RECALL['STATE'].'", "'.$row_RECALL['ZIP'].'", "'.$row_RECALL['EMAIL'].'", "'.$row_RECALL['PHONE'].'", "'.
