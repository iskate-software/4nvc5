...
$custom = $_SESSION['search'] ;
if ($_SESSION['skipref'] == '1') {
...
// }
 ...
 TITLE, CONTACT, COMPANY, ADDRESS1, ADDRESS2, CITY, STATE, ZIP, CAREA, CAREA2, PHONE, PHONE2, CYCLE,EMAIL) 
 ...
 ARCUSTO.CITY, ARCUSTO.STATE, ARCUSTO.ZIP, ARCUSTO.CAREA, ARCUSTO.CAREA2, ARCUSTO.PHONE, ARCUSTO.PHONE2, PETMAST.PVACOUNT,EMAIL FROM PETMAST 
 JOIN ARCUSTO ON (ARCUSTO.CUSTNO = PETMAST.CUSTNO) WHERE INSTR('12345678',PETTYPE) <> 0  AND INSTR(ARCUSTO.COMMENT,'NO REM') = 0 
 $skipref $namerange $annskip AND $custom ";
...
<form action="CUSTOM_SEARCH_RESULTS_PRINT.php" name="search_results" method="get" target="_blank">
