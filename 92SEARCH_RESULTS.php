...
<?php echo $openwin; ?>
	if (document.search_results.report[3].checked == true){
	document.getElementById('pcds').style.display="";
	}
	else {
	document.getElementById('pcds').style.display="none";
	}
document.search_results.xsubtype[0].checked = true;
}
...
<form action="SEARCH_RESULTS_PRINT.php" name="search_results" method="get" target="_blank">
