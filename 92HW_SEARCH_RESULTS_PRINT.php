...
<?php if ($_GET['report']=='Print List' || $_GET['report']=='Display List'){ ?>
  <table width="854" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" frame="void" rules="cols">
    <tr>
      ...
      <td align="center" bgcolor="#000000" class="Verdana11Bwhite">HW</td>
      <td align="center" bgcolor="#000000" class="Verdana11Bwhite">EXAM</td>
      <td align="center" bgcolor="#000000" class="Verdana11Bwhite">URT</td>
    </tr>    
     <?php do { ?>   
    <tr class="Verdana11">
    ...
    <tr class="Verdana12">
      ...
      <td align="center" class="Verdana12"><?php echo $row_RECALL['POTHFOR']; ?></td>
...
do { ?>   
  ...
  <tr>
    <td width="614" height="360" align="left" valign="bottom"><table width="614" border="0" cellspacing="0" cellpadding="0">
     
      <tr>
        <td height="45" colspan="3"><span class="Verdana14B"><?php echo $row_CRITDATA['HOSPNAME']; ?></span><br />
<span class="Verdana11"><?php echo $row_CRITDATA['HSTREET']; ?>, <?php echo $row_CRITDATA['HCITY']; ?>, <?php echo $row_CRITDATA['HPROV']; ?> <?php echo $row_CRITDATA['HCODE']; ?></span>
      ...
      <tr>
        <td height="<?php if ($i == 2) {echo '75';} else {echo '23';} if ($i == 3) {$i = 0;} ?>"></td>
        <td></td>
        <td></td>
      </tr>
    </table></td>
...
$fp = fopen("/Users/nvc/Desktop/HEARTWORM.TXT", "x") ;
  if ($fp) {
  ...
  $line = array($row_RECALL['CONTACT'], $row_RECALL['COMPANY'],'    ',  $row_RECALL['EMAIL'], $row_RECALL['TITLE'], $row_RECALL['PETNAME'], $heshe, $sex,  $isare ,
  $row_RECALL['ADDRESS1'], $row_RECALL['ADDRESS2'], $row_RECALL['CITY'], $row_RECALL['STATE'], $row_RECALL['ZIP'], $row_RECALL['PHONE'], '  ', '  ', '  ', $row_RECALL['PETTYPE'],
