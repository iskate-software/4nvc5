...
if ($xtable == 'PUPKIT') {
$xsearch = "Examined between <span class='Verdana12BBlue'>$startdate - $enddate</span>";
}
...
<title>PUPKIT CONFIRM PARAMETERS</title>
<!-- InstanceEndEditable -->
...
<form action="PUPKIT_SEARCH_RESULTS.php" name="confirmation" method="post">
