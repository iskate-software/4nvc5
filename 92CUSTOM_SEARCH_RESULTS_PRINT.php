...
<span class="Verdana11"><?php echo $row_CRITDATA['HSTREET']; ?>, <?php echo $row_CRITDATA['HCITY']; ?>, <?php echo $row_CRITDATA['HPROV']; ?> <?php echo $row_CRITDATA['HCODE']; ?></span></td>
      ...
      <tr>
        <td height="<?php if ($i == 3) {echo '0'; $i = 0;} else {echo "30";} ?>"></td>
        <td></td>
        <td></td>
      </tr>
    </table></td>
...
//  $fp = fopen("$DOCUMENT_ROOT/Merges/ANNUAL.TXT", "w") ;
 if (file_exists("/Users/nvc/Desktop/CUSTOM.TXT")) {
   unlink('/Users/nvc/Desktop/CUSTOM.TXT') ;
  }

$fp = fopen("/Users/nvc/Desktop/CUSTOM.TXT", "x") ;
  if ($fp) {
