...
document.pupkit.startweek.options[<?php echo $oldday; ?>].selected = true;
document.pupkit.endweek.options[<?php echo $oldday; ?>].selected = true;
document.pupkit.startmonth.options[<?php echo $oldmonth-1; ?>].selected = true;
document.pupkit.endmonth.options[<?php echo $oldmonth-1; ?>].selected = true;
}
...
<form action="PUPKIT_SEARCH_CONFIRMATION.php" name="pupkit" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      <tr>
        <td height="37" colspan="5" align="center" class="Verdana13B">DEFINE THE PUPPIES AND KITTENS SEARCH PERIOD</td>
        </tr>
      <tr>
